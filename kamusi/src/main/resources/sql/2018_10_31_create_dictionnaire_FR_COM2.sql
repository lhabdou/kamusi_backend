...
CREATE TABLE UTILISATEUR (
  ...
  CONSTRAINT fk_pays FOREIGN KEY (pays) 
  REFERENCES public.pays (code) MATCH SIMPLE ON UPDATE RESTRICT ON DELETE RESTRICT
);
ALTER TABLE public.UTILISATEUR OWNER TO postgres;
CREATE INDEX UTILISATEUR_FKIndex1 on ROLE using btree (ID);
CREATE INDEX UTILISATEUR_FKIndex2 on PAYS using btree (CODE);
